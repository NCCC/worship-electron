...
var _vuea = _interopRequireDefault(__webpack_require__(6));
...
var vueapp = new _vuea.default({
  ...
  methods: {
    ...
    openLyricsWindow: function (event) {
      console.log('Open lyrics', event, _path.default.join(__dirname, "lyrics.html"));
      ...
      if (!this.lyricsWindow) {
        ...
        this.lyricsWindow.loadURL(_url.default.format({
          pathname: _path.default.join(__dirname, "lyrics.html"),
          protocol: "file:",
          slashes: true
        }));
      } else {
