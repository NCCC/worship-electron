...
var _vueAlias = _interopRequireDefault(__webpack_require__(10));
...
var controlApp = new _vueAlias.default({
  ...
  methods: {
    ...
    transformVerse: function (index, verses) {
      ...
      var verse = verses[index]; // var item = document.createElement('richlistitem');
